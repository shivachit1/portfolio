        ...
        return (
            ...
            <div className="profile-container">
                ...
                <div className="home-greeting">
                    ...
                    <a href={cv} target="_blank" rel="noopener noreferrer"><button className="green-button">Download CV</button></a>
                    <div className="layout"> 
                        <h6>Feel free to checkout my recent projects.</h6>
                        
                    </div>
                    
                    <Link className="link" to="myProjects" spy={true} smooth={true} offset={-50} duration={500}><h6><button className="green-button">View Projects</button></h6></Link>
                </div>
