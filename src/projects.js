   ...
   ,[
    {
        ...
        details: "The project is a demo web-based application for selling glasses frames. Users can view the lists of items, add them to cart, and make an order smoothly. This project is carried out to learn handling an application state management system using Redux. React.js, Redux, CSS, and javaScript are used as building stacks for this website.",
        imageurl:"https://firebasestorage.googleapis.com/v0/b/portfoliowebsite-8eb68.appspot.com/o/frames.png?alt=media&token=bfefa148-e930-43ba-91b7-759612c019b6",
        info: {
            devices: "available via link",
            demoLink: "https://amazing-kirch-d3995a.netlify.app/",
    ...
    },
    {
        ...
        projectDescription: "Vue.js, Vuex, CSS, Router, JSON, Netlify for hosting",
        details: "Web-based event managing web application built using Vue.js, Vuex, CSS, Vue router. Users are asked to input their name so that they can create a new event or join any events that are public. In this project, I learned to build a simple website focusing on the frontend using Vue.js and Vuex for managing its whole application state.",
